...
public class FishBehaviour : MonoBehaviour
{
    ...
    [SerializeField] public float minHighLimit;
    [SerializeField] public float maxHighLimit;
    ...
    void Update()
    {
        ...
        if (transform.position.y <= minHighLimit)
            transform.position = new Vector3(transform.position.x, minHighLimit, transform.position.z);

        if (transform.position.y >= maxHighLimit)
            transform.position = new Vector3(transform.position.x, maxHighLimit, transform.position.z);
